...
// https://github.com/open-telemetry/opentelemetry-js/blob/1ce8a899cf2af1790787e48dad36769fe3af7b0d/experimental/packages/opentelemetry-exporter-prometheus/src/PrometheusSerializer.ts
// We cannot use the library itself because it's packaged in a manner that
// requires node.js (specifically the http package)
