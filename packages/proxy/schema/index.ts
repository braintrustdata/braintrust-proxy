...
export const AvailableEndpointTypes: { [name: string]: ModelEndpointType[] } = {
  ...
  "inception/mercury-2.5-preview": ["openrouter"],
  ...
  "computer-use-preview": ["openai", "azure"],
