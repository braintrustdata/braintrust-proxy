// NOTE: This is copied from https://github.com/open-telemetry/opentelemetry-js/blob/1ce8a899cf2af1790787e48dad36769fe3af7b0d/experimental/packages/opentelemetry-exporter-prometheus/src/PrometheusSerializer.ts
// which is bundled up in @opentelemetry/exporter-prometheus, which relies on http, which means it can only be
// included in Node.js environments.
/*
