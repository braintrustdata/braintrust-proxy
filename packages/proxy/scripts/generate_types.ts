...
async function main() {
  ...
  const banner = [
    `// Auto-generated file (internal git SHA ${internalGitSha})`,
    `// Generated by: proxy/packages/proxy/scripts/generate_types.ts`,
    `// DO NOT MODIFY - run 'make regenerate-proxy-types' from the repository root`,
    `// or 'pnpm dlx tsx scripts/generate_types.ts' from proxy/packages/proxy/`,
    ``,
  ].join("\n");
