...
export const AvailableEndpointTypes: { [name: string]: ModelEndpointType[] } = {
  ...
  "mistralai/Mistral-7B-Instruct-v0.1": ["togetherai"],
  "mistralai/Mixtral-8x22B": ["togetherai"],
  "mistralai/Mixtral-8x22B-Instruct-v0.1": ["togetherai"],
  "togetherai/Mixtral-8x22B-Instruct-v0.1": ["togetherai"],
  "mistralai/mixtral-8x7b-32kseqlen": ["togetherai"],
  "togetherai/Mixtral-8x7B-Instruct-v0.1": ["togetherai"],
  "togetherai/Mistral-7B-Instruct-v0.2": ["togetherai"],
  "meta-llama/Llama-2-70b-chat-hf": ["togetherai"],
  "meta-llama/Meta-Llama-3-70B": ["togetherai"],
  "meta-llama/Llama-3-70b-chat-hf": ["togetherai"],
  "meta-llama/Llama-3-8b-hf": ["togetherai"],
  "meta-llama/Llama-3-8b-chat-hf": ["togetherai"],
  "meta-llama/Llama-3.2-3B-Instruct-Turbo": ["togetherai"],
  "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo": ["togetherai"],
  "meta-llama/Llama-3.2-11B-Vision-Instruct-Turbo": ["togetherai"],
  "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo": ["togetherai"],
  "meta-llama/Llama-3.2-90B-Vision-Instruct-Turbo": ["togetherai"],
  "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo": ["togetherai"],
  "NousResearch/Nous-Hermes-2-Yi-34B": ["togetherai"],
  "deepseek-ai/deepseek-coder-33b-instruct": ["togetherai"],
