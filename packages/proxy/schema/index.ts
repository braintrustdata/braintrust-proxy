...
export const AvailableEndpointTypes: { [name: string]: ModelEndpointType[] } = {
  ...
  "gpt-5-codex": ["openai", "azure", "openrouter"],
  ...
  "o3-deep-research": ["openai", "azure", "openrouter"],
  ...
  "gpt-4o-mini-search-preview": ["openai", "azure", "openrouter"],
  "gpt-4o-search-preview": ["openai", "azure", "openrouter"],
