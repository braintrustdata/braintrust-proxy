...
export const AvailableEndpointTypes: { [name: string]: ModelEndpointType[] } = {
  ...
  "gpt-5.5-pro": ["openai", "azure", "openrouter"],
  "gpt-5.4-nano-2026-03-17": ["openai", "azure"],
  "gpt-5.4-pro-2026-03-05": ["openai", "azure"],
  "gpt-5.2-pro-2025-12-11": ["openai", "azure"],
  "gpt-5.2-pro": ["openai", "azure", "openrouter"],
  "gpt-5.1-codex-max": ["openai", "azure", "openrouter"],
  ...
  "deepseek-ai/DeepSeek-V4.1-Flash": ["baseten", "fireworks", "together"],
  ...
  "cohere/command-a-plus": ["openrouter"],
  "openai/gpt-6-luna-pro": ["openrouter"],
  "openai/gpt-6-sol-pro": ["openrouter"],
  "anthropic/claude-opus-5.5": ["openrouter"],
  "qwen/qwen3.8-omni-flash": ["openrouter"],
  "xiaomi/mimo-v2.6-pro-ultraspeed": ["openrouter"],
  ...
  "nvidia/nemotron-3.5-content-safety": ["openrouter"],
  "meta/muse-spark-1.3-contributor": ["openrouter"],
  "meta/muse-spark-1.3": ["openrouter"],
  "anthropic/claude-fable-5.1": ["openrouter"],
  "ibm-granite/granite-4.2-8b": ["openrouter"],
  ...
  "nvidia/nemotron-3.5-lightning": ["openrouter"],
  "sakana/sakana-namazu": ["openrouter"],
  "upstage/solar-pro4": ["openrouter"],
  ...
  "meituan/longcat-2.0": ["openrouter"],
  ...
  "aion-labs/aion-3.0-mini": ["openrouter"],
  "aion-labs/aion-3.0": ["openrouter"],
  ...
  "openai/gpt-chat-latest": ["openrouter"],
  "mistralai/mistral-medium-3-5": ["openrouter"],
  "qwen/qwen3.5-plus-20260420": ["openrouter"],
  ...
  "openai/gpt-5.4-image-2": ["openrouter"],
  ...
  "relace/relace-apply-3": ["openrouter"],
  ...
  "cognitivecomputations/dolphin-mistral-24b-venice-edition": ["openrouter"],
  ...
  "global.anthropic.claude-sonnet-5": ["bedrock"],
  ...
  "grok-4.20-non-reasoning-gv2": ["xAI"],
  "grok-4.20-reasoning-gv2": ["xAI"],
  "grok-4.20": ["xAI", "openrouter"],
  "grok-4.20-beta": ["xAI"],
  "grok-4.20-beta-latest": ["xAI"],
  "grok-4.20-beta-latest-non-reasoning": ["xAI"],
  "grok-4.20-beta-latest-reasoning": ["xAI"],
  "grok-4.20-beta-non-reasoning": ["xAI"],
  "grok-4.20-beta-reasoning": ["xAI"],
  "grok-4.20-experimental-beta-latest": ["xAI"],
  "grok-4.20-experimental-beta-non-reasoning-latest": ["xAI"],
  "grok-4.20-experimental-beta-reasoning-latest": ["xAI"],
  "grok-4.20-multi-agent": ["xAI", "openrouter"],
  "grok-4.20-multi-agent-beta-latest": ["xAI"],
  "grok-4.20-multi-agent-experimental-beta-latest": ["xAI"],
  "grok-4.20-multi-agent-latest": ["xAI"],
  "grok-4.20-non-reasoning": ["xAI"],
  "grok-4.20-non-reasoning-latest": ["xAI"],
  "grok-4.20-reasoning": ["xAI"],
  "grok-4.20-reasoning-latest": ["xAI"],
  "grok-4.20-0309": ["xAI"],
  ...
  "grok-4.20-experimental-beta-0304": ["xAI"],
  "grok-4.20-experimental-beta-0304-non-reasoning": ["xAI"],
  "grok-4.20-experimental-beta-0304-reasoning": ["xAI"],
  "grok-4.20-multi-agent-experimental-beta-0304": ["xAI"],
  ...
  "nvidia/nemotron-3-ultra-550b-a55b": ["together", "openrouter"],
  ...
  "gpt-5.2-codex": ["openai", "azure", "openrouter"],
  "gpt-5-chat-latest": ["openai", "azure"],
  "gpt-5-codex": ["openai", "azure"],
  "gpt-5.1-chat-latest": ["openai", "azure"],
  "gpt-5.1-codex": ["openai", "azure", "openrouter"],
  "gpt-5.1-codex-mini": ["openai", "azure", "openrouter"],
  ...
  "sonar-deep-research": ["perplexity", "openrouter"],
  ...
  "eu.anthropic.claude-opus-5": ["bedrock"],
  "au.anthropic.claude-opus-5": ["bedrock"],
  "claude-opus-5": ["anthropic", "openrouter"],
  "publishers/anthropic/models/claude-fable-5-1": ["vertex"],
  "anthropic.claude-fable-5-1": ["bedrock"],
  "global.anthropic.claude-fable-5-1": ["bedrock"],
  "publishers/anthropic/models/claude-fable-5": ["vertex"],
  "anthropic.claude-fable-5": ["bedrock"],
  "global.anthropic.claude-fable-5": ["bedrock"],
  ...
  "openai/gpt-oss-safeguard-20b": ["groq", "openrouter"],
  ...
  "databricks-claude-fable-5-1": ["databricks"],
  "databricks-claude-fable-5": ["databricks"],
  "databricks-claude-sonnet-4-5": ["databricks"],
  "databricks-claude-opus-4-6": ["databricks"],
  "databricks-claude-sonnet-4": ["databricks"],
  "databricks-gpt-5-4": ["databricks"],
  "databricks-gpt-5-4-nano": ["databricks"],
  "databricks-gpt-5-2": ["databricks"],
  "databricks-gemini-3-1-pro": ["databricks"],
  ...
  "databricks-gemini-3-1-flash-lite": ["databricks"],
  "databricks-gpt-oss-20b": ["databricks"],
  "databricks-qwen35-122b-a10b": ["databricks"],
  "databricks-qwen3-next-80b-a3b-instruct": ["databricks"],
  "thinkingmachines/inkling": ["baseten", "together", "openrouter"],
  "thinkingmachines/inkling-small": ["baseten", "together", "openrouter"],
  ...
  "mistral-medium-3": ["mistral", "openrouter"],
  ...
  "zai-org/GLM-5.3": ["baseten", "together"],
  "zai-org/GLM-5.3-Fast": ["baseten"],
  ...
  "ministral-14b-2512": ["mistral", "openrouter"],
  "ministral-8b-2512": ["mistral", "openrouter"],
  "ministral-3b-2512": ["mistral", "openrouter"],
  ...
  "accounts/fireworks/models/ember-1": ["fireworks"],
  ...
  "gpt-image-2.5-flare": ["openai", "azure"],
  "gpt-image-2.5-sunburst": ["openai", "azure"],
  "gpt-image-2.5-flare-2026-09-08": ["openai", "azure"],
  "gpt-image-2.5-sunburst-2026-09-08": ["openai", "azure"],
  "gpt-audio": ["openai", "azure", "openrouter"],
  "gpt-audio-mini": ["openai", "azure", "openrouter"],
  ...
  "gemini-3.5-flash": ["google", "vertex", "openrouter"],
  ...
  "gemini-3.1-pro-preview-customtools": ["google", "openrouter"],
  ...
  "publishers/google/models/gemini-embedding-2": ["vertex"],
  "publishers/google/models/gemini-embedding-001": ["vertex"],
  "publishers/google/models/gemini-2.5-flash": ["vertex"],
  "publishers/google/models/gemini-2.5-flash-image": ["vertex"],
  "publishers/google/models/gemini-2.5-flash-preview-09-2025": ["vertex"],
  ...
  "publishers/google/models/gemini-2.5-flash-lite-preview-09-2025": ["vertex"],
  ...
  "publishers/anthropic/models/claude-sonnet-5": ["vertex"],
  ...
  "openai/gpt-oss-20b": ["groq", "together", "openrouter"],
  ...
  "gpt-oss-120b": ["cerebras", "openrouter"],
  ...
  "gpt-5.4": ["openai", "azure", "openrouter"],
  "gpt-5.2": ["openai", "azure", "openrouter"],
  "gpt-5.1": ["openai", "azure", "openrouter"],
  "o3-pro": ["openai", "azure", "openrouter"],
  o3: ["openai", "azure", "openrouter"],
  "o4-mini": ["openai", "azure", "openrouter"],
  "gpt-4.1": ["openai", "azure", "openrouter"],
  "gpt-4.1-mini": ["openai", "azure", "openrouter"],
  "gpt-4.1-nano": ["openai", "azure", "openrouter"],
  "o1-pro": ["openai", "azure", "openrouter"],
  "gpt-4o-mini-search-preview": ["openai", "azure"],
  "gpt-4o-search-preview": ["openai", "azure"],
  "o3-mini": ["openai", "azure", "openrouter"],
  o1: ["openai", "azure", "openrouter"],
  "gpt-4o-2024-11-20": ["openai", "azure", "openrouter"],
  "gpt-4o-2024-08-06": ["openai", "azure", "openrouter"],
  "gpt-4o-mini": ["openai", "azure", "openrouter"],
  "gpt-4o-mini-2024-07-18": ["openai", "azure", "openrouter"],
  "gpt-4o": ["openai", "azure", "openrouter"],
  "gpt-4-turbo": ["openai", "azure", "openrouter"],
  "gpt-3.5-turbo-instruct": ["openai", "azure", "openrouter"],
  "gpt-daybreak-blue-latest": ["openai", "azure"],
  "gpt-daybreak-red-latest": ["openai", "azure"],
  "gpt-3.5-turbo-16k": ["openai", "azure", "openrouter"],
  "gpt-3.5-turbo": ["openai", "azure", "openrouter"],
  ...
  "databricks-gemini-3-pro-image": ["databricks"],
  ...
  "databricks-deepseek-v4-flash-0731": ["databricks"],
  "xai.grok-4.6": ["bedrock"],
  "us.xai.grok-4.6": ["bedrock"],
  "global.xai.grok-4.6": ["bedrock"],
  "openai.gpt-5.6-cyber": ["bedrock"],
  "openai.gpt-daybreak-blue-5.6-sol": ["bedrock"],
  "deepseek-ai/DeepSeek-V4-Pro-0813": ["together", "baseten"],
