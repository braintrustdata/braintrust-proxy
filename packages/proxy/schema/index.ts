...
export const AvailableEndpointTypes: { [name: string]: ModelEndpointType[] } = {
  ...
  "anthropic/claude-opus-5-fast": ["openrouter"],
  ...
  "kwaipilot/kat-coder-air-v2.5": ["openrouter"],
  ...
  "anthropic/claude-opus-4.8-fast": ["openrouter"],
  "anthropic/claude-opus-4.8": ["openrouter"],
  "qwen/qwen3.7-max": ["openrouter"],
  "anthropic/claude-opus-4.7-fast": ["openrouter"],
  ...
  "claude-fable-5-1": ["anthropic", "openrouter"],
  ...
  "low/1024-x-1024/grok-imagine-image-2.0": ["xAI"],
  ...
  "grok-imagine-image-quality-20260403": ["xAI"],
  "grok-imagine-image-2026-03-02": ["xAI"],
