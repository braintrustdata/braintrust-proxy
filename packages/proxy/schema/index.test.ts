...
// Test translating to OpenAI provider (should remove Braintrust-specific params)
it("translate to openai provider removes reasoning_enabled and reasoning_budget", () => {
  const input = {
    model: "gpt-4o",
    messages: [
      {
